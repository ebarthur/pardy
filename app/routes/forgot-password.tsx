...
export const action = async ({ request }: ActionFunctionArgs) => {
	...
	await send({
      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        <p>Hi 👋🏽,</p>
        <p>You requested to change your password. Click the button below to continue:</p>
        <p>
          <a href="${link}" style="display: inline-flex; align-items: center; gap: 8px; background-color: #2563eb; color: white; padding: 4px 8px; border-radius: 8px; font-weight: 500; font-size: 16px; text-decoration: none;">Reset Password</a>
        </p>
        <p>All the best!</p>
      </div>
    `,
